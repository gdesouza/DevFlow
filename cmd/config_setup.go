...
var setupConfigCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Println("You can now use 'devflow auth', 'devflow tasks', 'devflow repo', and 'devflow pullrequest' commands.")
		fmt.Println("")
		fmt.Println("Next steps:")
		fmt.Println("- List your tasks: devflow tasks list")
		fmt.Println("- Check Bitbucket auth: devflow auth status")
