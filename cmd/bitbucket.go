...
func init() {
	...
	pullrequestCmd.AddCommand(prCommentsCmd)
	pullrequestCmd.AddCommand(addCommentCmd)
	pullrequestCmd.AddCommand(prDiffCmd)
	pullrequestCmd.AddCommand(commentReplyCmd)
}
